...
<html lang="en"  >
  <head>
	...
	<link rel="shortcut icon" href="<?php echo base_url(); ?>assets/backend/image/rockfm-logo-ico.png" type="image/png"/>
   ...
   <noscript>
	   Liquid CP requires JavaScript for the interactive quotation flow.
   </noscript>
  </head>
